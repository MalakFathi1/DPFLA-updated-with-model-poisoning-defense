...
def generate_log_file(args):
    savepath = './logs_3/' + args.get_dataset_name() + '_' + args.get_model_name() + '_' + args.get_dd_type() +'_' + str(args.get_number_of_clients())  + '_' + args.get_attack_type1() + '_' + args.get_attack_type2() + '_' + args.get_rule() +'_' + "RFA" + '_' + str(
...
def run_exp(num_workers, frac_workers, attack_type1 ,attack_type2, rule, replace_method, dataset, malicious_rate,
    ...
    print(args.get_class_per_workers())
    print(args.get_num_workers())
